...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private void initView() {
		...
		sw_bool_light = (Switch) findViewById(R.id.sw_bool_light);
	}

	private void initEvent() {

		sw_bool_light.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_light:
			sendCommand(KEY_LIGHT, sw_bool_light.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_light.setChecked(data_light);
